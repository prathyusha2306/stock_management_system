...
public class AdminDAOImple implements AdminDAO {
	...
	public boolean addInvestor(Investor investor) {
		...
		investor.setInvestorId(investorInfo.getInvestorId());
		investor.setInvestorName(investorInfo.getInvestorName());
		investor.setMobileNumber(investorInfo.getMobileNumber());
		investor.setPassword(investorInfo.getPassword());
		investor.setEmailId(investorInfo.getEmailId());
		investor.setRole(investorInfo.getRole());
		EntityManager manager = null;
